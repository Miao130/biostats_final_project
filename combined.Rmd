...
```
To predict math score, the adjusted R^2 statistic and Cp shows that a 7-variable is 
model is optimal. The BIC shows 
...
results$which[7,]|>print()
```
To predict reading score, the adjusted R^2 statistic and $C_{p}$ shows that 
The predictors selected are: 
...
7 or 8-variable is model is optimal. The $C_{p}$ suggests a 7-variable model as well.\
The predictors selected are: 
