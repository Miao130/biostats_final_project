...
mult.fit = lm(math_score ~ ., data = step_df)
...
intercept_only <- lm (math_score ~ 1, data = step_df)
step(intercept_only, direction = "forward", scope = formula(mult.fit))
```
Reading Score
```{r}
mult.fit = lm(reading_score ~ ., data = step_df)
...
# fit using one function
intercept_only <- lm (reading_score ~ 1, data = step_df)
step(intercept_only, direction = "forward", scope = formula(mult.fit))
```
Writing Score
```{r}
mult.fit = lm(writing_score ~ ., data = step_df)
...
# fit using one function
intercept_only <- lm (writing_score ~ 1, data = step_df)
step(intercept_only, direction = "forward", scope = formula(mult.fit))
